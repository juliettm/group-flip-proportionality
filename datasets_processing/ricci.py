...
class RicciDataset(BaseDataset):
    ...
    def preprocess(self):
        ...
        df_base = pd.read_csv("/Users/juls/Documents/Repositories/classification_complexity/datasets/ricci/ricci.csv", header=0)
        ...
        # change priviledged and unpriviledged values
        df_base.loc[df_base['Race'] == 1, 'Race'] = 2
        df_base.loc[df_base['Race'] == 0, 'Race'] = 1
...
# df = RicciDataset('Race', outcome_type='binary')
# df._ds.to_csv('../data/ricci.csv', index = False)